          ...
          <li>
            <NavLink to="/movies" className={styles["nav-list-item"]}>
              <svg
                aria-hidden="true"
                className={`${styles["nav-icon"]} ${
                  styles[currentPath === "/movies" ? "current" : ""]
                }`}
                viewBox="0 0 16 16"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="sr-only">Movies Page</span>
            </NavLink>
          </li>
          <li>
            <NavLink to="/tvseries" className={styles["nav-list-item"]}>
              <svg
                aria-hidden="true"
                className={`${styles["nav-icon"]} ${
                  styles[currentPath === "/tvseries" ? "current" : ""]
                }`}
                viewBox="0 0 16 16"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="sr-only">TV Series Page</span>
            </NavLink>
          </li>
          <li>
            <NavLink to="/bookmarked" className={styles["nav-list-item"]}>
              <svg
                aria-hidden="true"
                className={`${styles["nav-icon"]} ${
                  styles[currentPath === "/bookmarked" ? "current" : ""]
                }`}
                viewBox="0 0 14 16"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              ...
              <span className="sr-only">Bookmarked Page</span>
            </NavLink>
          </li>
        </ul>
      </nav>
